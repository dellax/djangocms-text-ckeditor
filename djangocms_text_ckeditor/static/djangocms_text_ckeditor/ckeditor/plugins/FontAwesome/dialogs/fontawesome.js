...
CKEDITOR.dialog.add('fontawesomeDialog', function(editor) {
    return {
        title: 'Vložiť ikonku font awesome',
        minWidth: 600,
        minHeight: 400,
        resizable: false,
        contents: [{
            ...
            elements: [ {
                ...
                children: [{
                    ...
                    items: [
                        ['Normálne', ''],
                        ['Otočiť o 90', 'fa-rotate-90'],
                        ['Otočiť o 180', 'fa-rotate-180'],
                        ['Otočiť o 270', 'fa-rotate-270'],
                        ['Otočiť hirizontálne', 'fa-flip-horizontal'],
                        ['Otočiť vertikálne', 'fa-flip-vertical']
                    ],
                    setup: function(widget) {
